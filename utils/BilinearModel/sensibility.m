...
roi_ch = 1:4; %Simulando 4 canales
r = 0;
channels = 4;
voxels = 2;
wavelengths = 2;
...
ns = 4; % # of source
nd = 4; % # of detector
xyz_d = zeros(3,nd);  %pos_o.d.xyzH; -  MNI coordinates of hemodynamic source positions 

node_mm = [1,1,1;]; 
n_node = size(zeros(3,voxels), 2); 
