...
# read CDM SCALE --------------------------------------------------------------------------------
cdmscale_diff_phase = np.genfromtxt("../Outputs/Dataframes/dataframe_test_distances_time_cdmscale.csv", delimiter=',')
...
fig['layout']['xaxis2']['title']='Distances time'
fig['layout']['yaxis2']['title']='Distances time'

# Read distance function ---------------------------------------------------------------------
cdmscale_diff_fun = np.genfromtxt("../Outputs/Dataframes/dataframe_test_distances_function_time.csv", delimiter=',')
