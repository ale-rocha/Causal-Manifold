...
# read CDM SCALE --------------------------------------------------------------------------------
cdmscale_diff_phase = np.genfromtxt("../Outputs/Dataframes/dataframe_test_distances_phase_cdmscale.csv", delimiter=',')
...
fig['layout']['xaxis2']['title']='Distances cos(phase)'
fig['layout']['yaxis2']['title']='Distances sin(phase)'

# Read distance function ---------------------------------------------------------------------
cdmscale_diff_fun = np.genfromtxt("../Outputs/Dataframes/dataframe_test_distances_function_cdmscale.csv", delimiter=',')
